...
public class SignUpFormController implements Initializable {
    ...
    void btnSignUpOnAction(ActionEvent event) throws Exception {
        ...
        String Confirmpassword = txtRePassword2.getText();
        String email = txtUserEmail.getText();
        String role = (String) txtrole.getValue();


        int validationCode;
        String encryptedrePassword = PasswordEncrypt.hashPassword(Confirmpassword);
        if (id.isEmpty() || name.isEmpty() || password.isEmpty() || Confirmpassword.isEmpty() || email.isEmpty() || role == null) {
        ...
        switch (validationCode) {
            ...
            case 4 -> new Alert(Alert.AlertType.ERROR, "Invalid Confirmpassword format!").show();
            default -> {
